...
Hi there! I'm Alba, an Advanced Technician in Multiplatform Application Development, and I'm currently working as a Senior Assistant, Software Engineering at Kyndryl. I'm gaining hands-on experience and sharpening my technical and problem-solving skills every day.
...
- **Senior Assistant Software Engineer, Kyndryl**  
  _September 2025 - Present_  
  Python scripting to migrate PostgreSQL databases OnPrem or clouds like AWS/Azure/GPC. Also postmigration scripts in Bash and VM migration tasks with VMware and Zerto.
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  A lightweight shell implemented in Go for educational purposes.
</div>
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  CRUD service for Magic: The Gathering Commander games.
</div>
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  API Gateway for authentication and CRUD routing.
</div>
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  User login, registration, and profile management API.
</div>
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  Personal documentation and guides.
</div>
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  GitHub Actions workflow for Telegram notifications.
</div>
...
<div style="border:1px solid #bb86fc; border-radius:8px; padding:1em; width:300px; background:#23272f; color:#e0e0e0;">
  ...
  <br>
  Real-time system and Docker monitoring bot.
</div>
...
- **CFGS - Platform Application Development**  
  ...
  Programming in Java, Python, Kotlin. REST APIs, Android Studio, Docker, VirtualBox.
